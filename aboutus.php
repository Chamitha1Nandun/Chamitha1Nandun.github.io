...
<div class="white2">	
<h3 id="h123">About Us</h3>
	<p id="about"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Regular service can help to keep your car running smoothly and identify potential problems early on, reducing the risk of more serious and costly problems in the future, and also reducing the risk of breakdown. Bring your vehicle to us. We are the best option you've got. </p>
	<a name="vision"><h3 class="abttit">Our Vision</h3></a><hr width="90%"/>
  <p id="about">Clean Street Auto Service is a leader in its field. To maintain that position, its plans for the coming years include: </p>
	<ul id="aboutlist"><li class="abtlist">Combining internal growth with external, acquisitions based growth. </li>
        <li class="abtlist">Expanding its presence in major Cities. </li></ul>
	<p id="about">To achive this we are giving priority to good governance of our company and relations with our business partners,in line with ethical principles: </p><ul id="aboutlist">
	<li class="abtlist">Our first concern is Qulity of Service.</li>
	<li class="abtlist">We respect a social policy based on equity among those with whom we work.</li>
	<li class="abtlist">We are developing a respectful environment policy.</li></ul>
	<a name="mission"><h3 class="abttit">Our Mission</h3></a><hr width = "90%"/>
  <p id="about">Our target is exellence and the maintaince of strict performance standards, aimed at creating "a unique Modern Car Service Experience". To achive this, we have been putting a number of processes in place: </p>
	<ul id="aboutlist"><li class="abtlist">Continuous Service improvements. </li>
	                   <li class="abtlist">Staff training. </li>
		               <li class="abtlist">Anticipating client expectations. </li>
		               <li class="abtlist">Opening up dialogue with clients, partners and workers. </li>
		               <li class="abtlist">Putting our expertice to good use. </li>
		               <li class="abtlist">Investing a new computer based management system. </li>
	</ul>
	<div class="videoabt">
	  <video width="400" height="auto" controls autoplay = "yes"><source src="videos/video.mp4" type="video/mp4">Your browser dosent support the video.</video>
	</div>
