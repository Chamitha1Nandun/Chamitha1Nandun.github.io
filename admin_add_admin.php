...
<html>
	...
	<!--
		function testform() {
			...
			return confirm("Do you want to add this person as an Administrator ?");
		}
	//-->
	</script>
  ...
  <form name="user" method="post" enctype = 'multipart/form-data' action="">
	...
	<div class="input-group">
      ...
      &nbsp;&nbsp;
  	  <button type="submit" class="btn" name="admin_reg_admin" onClick="return testform()">Add Administrator</button>
  	</div>	
