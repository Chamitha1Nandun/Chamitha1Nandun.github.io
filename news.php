    ...
    <div class="header">
        ...
        <div class="subnavi">          
                ...
                <button type="submit" name="out">Logout</button>                   
					...
					echo "<meta http-equiv='refresh' content='30;url=http://localhost/web/admin_add_news.php'>"	;
					echo "<h4>";
					echo "Hello, ",($_SESSION['name']);
					echo "</h4>";
				    echo '  <form action="includes/logout.inc.php" method="POST" >
...
<div class="white">
	<H1 style="color:red" align="center"><u>Hot News</u></H1>
	<hr>
	<div class ="news">
	<table border=0 width=735px cellpadding=5px >
	<?php 
	include 'includes/dbh.inc.php';
       ...
       echo '<tr style="color:blue; font-family:Arial; font-size:30px; text-align:center; "><th><u>'.$row["Headline"].'</u></th></tr><tr><td style="font-size:20px; text-align:justify">'.$row["Content"].'</td></tr><tr><td align=center><img src="'.$row["picture_path"].'" width=700px></td></tr>';
