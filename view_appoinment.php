...
<div class="latest">
<div class="fb-page" data-href="https://www.facebook.com/facebook" data-tabs="timeline" data-width="250" data-height="290" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/facebook" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/facebook">Facebook</a></blockquote></div>
...
<div class="white">
	<div class ="shop">
	<img src="img/staff1.jpg" width= "900px" height="auto" alt =shop>
	</div>
	<br /><br />
	<div class ="staff">
	<table border=1 cellpadding=8px width=900px>
	<tr align=center><th>Appoinment-ID</th><th>Name</th><th>Email</th><th>Vehicle Number</th><th>Vehicle Type</th><th>Service Type</th><th>Free Date 1</th><th>Free Date 2</th><th>Approve</th><th>Reject</th><th>Delete</th></tr>
	...
	<?php 	   
       ...
       echo '<tr align=center><td>'.$row["appointment_ID"].'</td><td>'.$row["first_name"]." ".$row["last_name"].'</td><td>'.$row["email"].'</td><td>'.$row["vehicle_number"].'</td><td>'.$row["vehicle_type"].'</td><td>'.$row["service_type"].'</td><td>'.$row["free_1"].'</td><td>'.$row["free_2"].'</td>';
	   echo '<td><form method="POST" action="delete.php"><input type ="hidden" name="email" value="'.$row["email"].'"><button class = "btn_app" type="submit" name="approve_me">Approve</button></form></td>';
	   echo '<td><form method="POST" action="delete.php"><input type ="hidden" name="email" value="'.$row["email"].'"><button class = "btn_app" type="submit" name="reject_me">Reject</button></form></td>';
	   echo '<td><form method="POST" action="delete.php" onSubmit="check()"><input type ="hidden" name="id_app" value="'.$row["appointment_ID"].'"><button class = "btn_app"  type="submit" name="delete_app">Delete</button></form></td></tr>';                   
               }
	...
	?>
	 ...
	 <p>
		...
		? <a class="member" href="data_accounts.php">Click here</a>
  	</p>
	</div>
